...
const labels = {
  "zh-Hant": {
    ...
    duration: "考試時間",
    total: "滿分 150 分",
    instruction: "所有題目均為單選題。材料框屬於題目；請把答案填在另紙，列印前確認組別、難度與頁碼。",
    print: "列印／另存 PDF",
    answer: "答案",
    explanation: "解析",
    marks: "分",
  ...
  ja: {
    ...
    duration: "試験時間",
    total: "満点 150点",
    instruction: "全問単一選択。資料枠も問題の一部。解答は別紙へ記入し、印刷前に区分・難度・頁を確認すること。",
    print: "印刷／PDF保存",
    answer: "解答",
    explanation: "解説",
    marks: "点",
  ...
  en: {
    ...
    instruction: "All items are single-choice. Source boxes are part of the question. Record answers separately and confirm track, difficulty, and page order.",
