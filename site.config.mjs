export const site = {
  ...
  pages: [
    ...
    },
    {
      ...
      title: "卒業判定、進路室與百鬼夜行校友會｜幻想鄉立東方大學",
      description: "以八席卷宗判定卒業、媒合十二處幻想鄉進路，並加入按共同問題分支的百鬼夜行校友會。",
      eyebrow: "GRADUATION × CAREERS × ALUMNI",
      heading: "卒業判定、進路室與百鬼夜行校友會",
      lead: "學位不會消滅爭議；它只把學分、答辯、借書、退宿與那件仍值得追問的事，一起完整封進卷宗。",
      ...
      sections: ["careers"],
      styles: ["forms", "responsive-extras", "search", "pages", "careers", "print-documents", "readability"],
    },
    {
      id: "campus",
      output: "campus.html",
