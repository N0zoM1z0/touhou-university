...
const copy = {
  "zh-Hant": {
    ...
    reviewer: "願意署名保留的審閱者",
    reason: "為什麼值得保存",
    reasonPlaceholder: "例如：能保留一種具代表性的誤認、形成新的可驗證問題，或物品本身堅持這個用途……",
  ...
  ja: {
    ...
    supported: "用途は証拠により十分裏付けられている",
    provisional: "暫定用途・追加端子または版証拠待ち",
    unsupported: "元の用途は裏付けられず",
    contested: "赤鉛筆係争保存",
    score: "鑑定完成度",
    evidence: "採用証拠",
    tests: "実施試験",
    ...
    retentionWarning: "正しい鑑定になるわけではありません。後続記録・My TU・BBSにも「裏付けられず」と明記されます。",
    reviewer: "保存へ署名する査読者",
    reason: "保存する価値",
