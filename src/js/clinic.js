...
const copy = {
  ...
  ja: {
    ...
    title: "まず、どこに不調があるかを言葉にする。道と薬で揉めるのは、その後だ。",
    lead: "本部保健室は日常的なけがを、永遠亭は種族をまたぐ症例や、月相・境界・魔法素材への曝露を担当する。トリアージ、診察、処方、調剤、回復の記録は、この端末にのみ保存される。",
    ...
    careNetwork: "二つの診療所と、てゐが置き場所を変えてしまう一枚の紹介状。",
