...
const copy = {
  ...
  ja: {
    eyebrow: "MY TU / COURSE REGISTRATION",
    title: "授業を生活に組み込み、教室がまだ元の場所にあるか確かめる。",
    lead: "七学部35科目を検索。履修登録・取消し、キャンセル待ち、履修前提科目、通常の時間割では扱えない衝突まで、この端末で即時に判定する。18単位は注意の目安であって、結界ではない。",
    records: "学籍ホーム",
    registration: "履修・成績",
    workbench: "課題・試験・答弁",
    term: "受付学期",
    ...
    openOnly: "空席あり",
    waitlistOnly: "満員／キャンセル待ち可",
    applyFilters: "検索",
    resultCount: "科目",
    seats: "定員",
    seatsOpen: "空席",
    full: "満員",
    noWaitlist: "キャンセル待ちなし",
    prerequisite: "前提",
    noPrerequisite: "なし",
    meeting: "時間",
    instructor: "担当",
    ...
    selected: "履修済",
    onWaitlist: "キャンセル待ち",
    waitlistPosition: "この端末でのキャンセル待ち順位",
    ...
    waitlistedToast: "満員のため、この端末のキャンセル待ちに登録しました。",
    droppedToast: "履修を取り消しました。出来事は残りますが時間割から外れます。",
    cancelledToast: "キャンセル待ちを取り消しました。",
    unavailableToast: "満員でキャンセル待ちを受け付けません。",
