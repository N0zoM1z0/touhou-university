...
const copy = {
  "zh-Hant": {
    ...
    activeNow: "這張運行票正在改動主校園",
    activeNote: "封路已進入地圖算法，預估候診也已進入永遠亭運行盤；結祭後兩者會一起釋放。",
    documentTitle: "祭典共同運營許可書",
    reportTitle: "祭典結祭運營報告",
  },
  ja: {
    eyebrow: "FESTIVAL OPERATIONS / 春季スペルカード灯会 × 境界開学祭",
    title: "祭典は成功点ではなく、一晩同時に動くキャンパス。",
    lead: "行列、空域、屋台、給電、正門、救護所を編成し、六つの机が別々に押印する。開祭後、文の号外、妖精の雲、守矢の電気、騒霊の深夜音は予定表への服従を保証しない。",
