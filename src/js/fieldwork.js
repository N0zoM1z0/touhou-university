...
const copy = {
  ...
  ja: {
    eyebrow: "FIELDWORK PASSPORT / 境内実習 × フィールド調査",
    title: "地図は行き方を示す。旅券は、なぜ行き、何を見て、誰が異議を唱えたかまで覚える。",
    lead: "二十四の実習所には別々の入口規則、指導者、厄介事がある。派遣令、現地点呼、一件の予定外、観察・来歴鎖・研究利用判断を持ち帰る。",
    ...
    dispatchTitle: "境内実習派遣令を記入", station: "実習所", fieldName: "旅券署名／当番名", purpose: "今回答えるフィールド問い",
    ...
    approved: "派遣許可", conditional: "条件付派遣", conditions: "出発前附件", permit: "境内実習派遣令",
    ...
    returnLog: "帰校観察・資料源報告", observation: "直接観察／実施内容",
    observationPlaceholder: "見たこと、聞いたこと、推測を分ける。不明も残せる。", sourceKind: "主要資料源形式", sourceNote: "資料源・版・取得方法",
    ...
    passportTitle: "境内実習・フィールド調査旅券", passportLead: "印は追跡可能な学びを持ち帰った証明で、全争議解決の証明ではない。",
  ...
  en: {
    ...
    lead: "Twenty-four stations keep distinct entry rules, supervisors, and complications. Receive dispatch, check in, handle one refusal to follow plan, then return observation, provenance, and a research-use decision.",
