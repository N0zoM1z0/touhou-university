...
const copy = {
  ...
  ja: {
    ...
    renewed: "延長しました。新しい返却期限を端末内貸出票に記録しました。",
    returned: "返却しました。書架は一旦受入れに同意しました。",
    holdCancelled: "予約を取り消しました。列が一つ進みました。",
    renewalLimit: "この本は延長回数を使い切りました。",
    renewalBlocked: "予約者がいるため延長できません。",
    due: "返却期限",
    overdue: "延滞",
    borrowedOn: "貸出日",
    holdPlaced: "予約日",
  ...
  en: {
    ...
    lead: "Search the collection, borrow available books, place holds on items that are checked out or temporarily off the shelf, and renew loans before they are due. Every action stays on this device.",
    open: "Open today",
    closed: "Closed today",
