...
const sectionEntries = [
  ...
  ["festival-operations", "festival", ["春季符卡燈會／境界開學祭運營室", "春季スペルカード灯会／境界開学祭運営室", "Spring Spell-card Lantern / Boundary Festival Operations"], ["六桌許可、開祭值班、現場事故、改道、候診與結祭報告", "六机許可・開祭当番・現場案件・迂回・待合・閉祭報告", "Six-desk permits, opening duty, field cases, detours, clinic load, and closure reports"]],
