...
const copy = {
  ...
  en: {
    ...
    categories: {
      ...
      map: "Map",
      history: "Chronicle",
      knowledge: "Hieda Index",
      ethics: "Research ethics",
      festival: "Festival operations",
      fieldwork: "Fieldwork",
      orientation: "New-student arrival",
      course: "Course",
...
const sectionEntries = [
  ...
  ["admissions", "section", ["招生與入學指南", "入試・入学案内", "Admissions"], ["入學路線、日期與線上申請", "選抜経路・日程・オンライン出願", "Entry routes, dates, and online application"]],
  ["welcome", "orientation", ["第一鐘・新生到着週", "第一鐘・新入生到着週", "First Bell · New Student Arrival Week"], ["正式錄取後核對路線、停止信號與第一站", "正式合格後の経路・停止合図・最初の行先", "After formal admission, confirm a route, stop signal, and first destination"]],
  ...
  ["festival-operations", "festival", ["春季符卡燈會／境界開學祭營運室", "春季スペルカード灯会／境界開学祭運営室", "Spring Spell-card Lantern / Boundary Festival Operations"], ["六桌許可、開祭值班、現場事故、改道、候診與結祭報告", "六机許可・開祭当番・現場案件・迂回・待合・閉祭報告", "Six-desk permits, opening duty, field cases, detours, clinic load, and closure reports"]],
  ["fieldwork-stations", "fieldwork", ["境內實習與田野調查護照", "境内実習・フィールド調査旅券", "Domestic Placement & Field Inquiry Passport"], ["二十四實習站、派遣令、現場偏差、來源鏈、返校回報與場地印", "二十四実習所・派遣令・現場偏差・来歴鎖・帰校報告・現地印", "Twenty-four stations, dispatch, field complications, provenance, returns, and station seals"]],
